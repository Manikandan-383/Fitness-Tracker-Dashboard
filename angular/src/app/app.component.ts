...
export class AppComponent {
  ...
  generatePDF() {
    ...
    pdf.text(`Date: ${this.joiningDate}`, 20, y);
    y += 15;

    pdf.text('To,', 20, y);
    y += 10;

    pdf.text(`Mr./Ms. ${this.candidateName}`, 20, y);
    y += 15;

    pdf.text(`Dear ${this.candidateName},`, 20, y);
    y += 15;
    ...
    pdf.text('____________________', 20, y + 30);
    pdf.text('HR Manager', 20, y + 40);
    pdf.text('Debugiz Technologies', 20, y + 50);
